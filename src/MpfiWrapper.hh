    ...
    public:
      ...
      /*  MpfiWrapper &copy(const MpfiWrapper &r,
        ...
        */
        ...
        bool disjoint(MpfiWrapper const & m) const {
            return (this -> upper () <= m.lower()) || (this -> lower() >= m.upper());
        }

        bool has_intersection(MpfiWrapper const & m) const {
            return ! (this -> disjoint(m));
        }
